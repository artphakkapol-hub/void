--[[
  ...
  Conventions:
    ...
    This file handles the English localization for the VOID script.
]]
...
["main.initializing"] = "Initializing script...",
["main.no_app_found"] = "Game application not found",
...
["main.multiple_spaces_title"] = "Multiple Virtual Spaces Detected",
["main.multiple_spaces_desc"] = "HCR2 was found in %d virtual spaces.\nSelect the space you are currently playing in.",
["main.select_space_toast"] = "Please select a virtual space to continue.",
...
["main.initialized"] = "Initialization Done",
["main.gamestatus_not_found"] = "GameStatus Not Found",
["main.dont_interrupt"] = "Do not interrupt this script",
...
["settings.clear_memory.desc"] = "Clear all VOID saved memory without needing to restart the whole game.",
...
["settings.reset_theme.desc"] = "Reset custom theme and background image to default",
...
["settings.export_theme.size_warning_msg"] = "Include custom background image? It will increase the upload size depending on your image resolution. Proceed anyway?",
...
["settings.tabs_icon.hint"] = "Enter Icon Code",
...
["settings.bg_image_picker.success_title"] = "Success",
...
["settings.accent_rgb.desc"] = "Tint for buttons, toggles, and active cards",
...
["other.debug_mode.title"] = "In-Game Debug Mode",
["other.debug_mode.desc"] = "Toggle the in-game debug mode option",
...
["other.resolution_offset.desc"] = "Adjust the game width offset and height offset (default is 0x0). Best for low resolution on a large screen.",
...
["player.auto_detach.title"] = "Auto Detach Parts",
["player.auto_detach.desc"] = "Automatically detach vehicle parts like the Rally Car roof",
["player.no_clip.title"] = "No-Clip",
["player.no_clip.desc"] = "Make your player go through objects without dying (You can cross the finish lines in cups)",
["player.no_clip.enabled"] = "No-Clip Enabled",
["player.no_clip.disabled"] = "No-Clip Disabled",
["player.hide_name.title"] = "Hide Name",
["player.hide_name.desc"] = "Hide your player name during a race",
["player.hide_name.enabled"] = "Hide Name Enabled",
["player.hide_name.disabled"] = "Hide Name Disabled",
["player.hide_flag.title"] = "Hide Flag",
["player.hide_flag.desc"] = "Hide your player flag during a race",
["player.hide_flag.enabled"] = "Hide Flag Enabled",
["player.hide_flag.disabled"] = "Hide Flag Disabled",
["player.zoom.title"] = "Adjust Zoom",
["player.zoom.desc"] = "Adjust how close or far the camera is",
["player.slider.min"] = "Min",
["player.slider.max"] = "Max",
["player.gravity.title"] = "Adjust Gravity",
["player.gravity.desc"] = "Adjust how strong the gravity is",
["player.slider.x"] = "X-Axis",
["player.slider.y"] = "Y-Axis",
...
["adventure.auto_adventure_chests.done"] = "Task Finished",

["adventure.set_distance.title"] = "Set Distance",
["adventure.set_distance.desc"] = "Sets your Adventure race distance to a custom value. Must be in an active race. Higher distance rewards more stars. Max stars at 5000m. (Not a teleport function)",
...
["adventure.set_distance.loop_will_stop"] = "Loop will stop after current interval tick.",
["adventure.set_distance.prompt_target"] = "Target distance (meters)",
["adventure.set_distance.prompt_loop"] = "Loop (auto re-apply value)",
["adventure.set_distance.prompt_interval"] = "Loop interval (ms, min 250)",
["adventure.set_distance.over_max_title"] = "Distance Warning",
["adventure.set_distance.over_max_msg"] = "Distance over 5000m won't give you any more stars.\n\nThe race will still register the distance, but no extra star rewards will be given. Proceed anyway?",
