...
["tabs.account"] = "เมนูไอดี",
["tabs.vehicle"] = "เมนูรถ",
["tabs.player"] = "เมนูผู้เล่น",
["tabs.adventure"] = "เมนูผจญภัย",
["tabs.cups"] = "เมนูถ้วยรางวัล",
["tabs.team"] = "เมนูทีม",
["tabs.event"] = "เมนูกิจกรรม",
...
["settings.gamestatus_raw.title"] = "ตำแหน่ง GameStatus (Raw)",
...
["settings.export_theme.size_warning_msg"] = "จะมัดรวมรูปพื้นหลังไปด้วยไหม? ขนาดไฟล์จะใหญ่ขึ้นตามความละเอียดของรูปภาพนะ จะลุยต่อไหม?",
...
["settings.slider.alpha"] = "ค่าโปร่งใส (Alpha)",
...
["settings.slider.r"] = "แดง (R)",
["settings.slider.g"] = "เขียว (G)",
["settings.slider.b"] = "น้ำเงิน (B)",
...
["shop.change_chest.options"] = {
    ...
    "กล่องแชมป์เปี้ยน", "กล่องพิเศษ 1", "กล่องคริสต์มาส", "กล่องตำนาน",
    "กล่องสีน้ำเงิน", "กล่อง VIP 1", "กล่อง VIP 2", "กล่องวิดีโอโฆษณา",
    "กล่องเริ่มต้น", "กล่องพิเศษ 2", "กล่องฟิงเกอร์ซอฟต์", "กล่องเมก้า",
    "กล่องทีมสปิริต", "กล่องสไตล์แฟชั่น", "กล่องลึกลับ"
},

-- ── modules/tabs/player.lua ───────────────────────────────────────────────────
["player.auto_detach.title"] = "ถอดชิ้นส่วนรถออโต้",
["player.auto_detach.desc"] = "สั่งถอดชิ้นส่วนรถออกอัตโนมัติ เช่น หลังคารถแรลลี่",
["player.no_clip.title"] = "ทะลุวัตถุ (No-Clip)",
["player.no_clip.desc"] = "ทำให้ตัวละครขับทะลุสิ่งกีดขวางได้โดยไม่ตาย (ขับทะลุเข้าเส้นชัยในโหมดถ้วยรางวัลได้เลย)",
...
["player.hide_flag.desc"] = "ซ่อนรูปธงชาติของตัวเองตอนกำลังแข่งอยู่",
["player.hide_flag.enabled"] = "เปิดใช้งานซ่อนธงแล้ว",
["player.hide_flag.disabled"] = "ปิดใช้งานซ่อนธงแล้ว",
["player.zoom.title"] = "ปรับระดับกล้อง (Zoom)",
...
["player.slider.x"] = "แกน X",
["player.slider.y"] = "แกน Y",

-- ── modules/tabs/adventure.lua ────────────────────────────────────────────────
["adventure.auto_adventure_chests.title"] = "อัปเวลกล่องผจญภัยออโต้ (ยังไม่นิ่ง)",
["adventure.auto_adventure_chests.desc"] = "เร่งระดับเลเวลกล่องโหมดผจญภัยให้เองอัตโนมัติ",
["adventure.auto_adventure_chests.none_found"] = "ไม่เจอกล่องโหมดผจญภัย",
["adventure.auto_adventure_chests.done"] = "ทำเสร็จเรียบร้อย",
...
["adventure.set_distance.prompt_loop"] = "ตั้งวนลูป (สั่งเขียนค่าทับออโต้)",
